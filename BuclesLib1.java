...
class BuclesLib1
{
	...
	public static int sumaNWhile (int n)
	{
		int resultado = 0;
		int i=1;
		while (i <= n)
	...
	public static boolean hayPrimos (int a, int b)
	{
		boolean enc = false;
		int i = a ;
		while (i <= b && !enc)
	...
	public static int sumaDig2 (int n)
	{
		int resultado = 0;
		int numCifras = numeroCifras (n);
		for (int i = 1; i <= numCifras; i++)
	...
	public static int anillosNumero2 (int numero)
	{
		int resultado = 0;
		int numCifras = numeroCifras (numero);
		for (int i = 1; i <= numCifras; i++)
		{
			resultado = resultado + anillosDigito (cifraI(i,numero));
		}
		return resultado;
	}
